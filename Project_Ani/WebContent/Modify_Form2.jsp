...
<body>
	...
	<font id="font1">&nbsp;&nbsp;회원정보 변경</font>

		<hr id="hr2">
        <font id="font4">기본정보</font>
        <hr id="hr2">
	
        <form action = "#" method="post"  name="userInfo" onsubmit="return checkValue()">
           <table style="width:90%; height:60%;"border="0" solid silver;">
                  <tr>
                    <td id="title">아이디</td>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="btn4" type="button" value="비밀번호 변경" >
                    </td>
                </tr>
                <tr>
                    <td id="title">새비밀번호</td>
                    <td>
                        <input type="password" name="passwordcheck" maxlength="30">
                        <input type="password" name="passwordcheck" maxlength="30">
                    </td>
		...
		<tr>
           ...
           <td>
            ...
            <hr id="hr2">
            <div id="div1"><br>
            <input id="btn1" type="submit" value="정보수정" style="width:100pt; height:30pt"> 
